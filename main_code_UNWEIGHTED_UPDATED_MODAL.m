...
load no_weight_data.mat;   % Comment/uncomment whichever data file is being analyzed.
...
Himag1 = [-0.1556 0.1822 -0.2466 -0.2445 -0.2245 1.078 1.081];
Himag2 = [-0.2743 -0.08335 -0.2902 -0.9772 -0.6561 -1.547 -0.452];
Himag3 = [0.3966 -0.2503 0.1894 -0.1348 -0.7507 1.352 0.09789];
Himag4 = [-0.323 -0.2586 -0.189 0.02256 0.5214 1.404 0.5595];
Himag5 = [0.4031 -0.2317 -0.2017 0.1924 -0.03837 0.9459 -0.335];
Himag6 = [-0.2986 -0.1152 0.3078 1.034 0.08588 -1.382 -0.4724];
Himag7 = [0.1311 0.2647 -0.02865 -0.5738 0.1399 1.773 -0.7994];
